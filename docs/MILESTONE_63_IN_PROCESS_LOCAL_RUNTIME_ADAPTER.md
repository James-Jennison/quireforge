...
and the closed CMake configuration. The build script compiles only the static
`llama` target and its CPU ggml dependencies. Full repository validation remains
