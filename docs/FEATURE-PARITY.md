...
| Worktrees                              | Public desktop supports managed/permanent worktrees | Git CLI; Codex cwd                                                        | Inventory/create/attach and bounded parallel use complete; cleanup remains    | M11A–11B complete locally / 11C planned       |
