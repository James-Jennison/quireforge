...
| --- | --- | --- | ---: | ---: | --- | --- | --- |
| Post-M41 packaging-efficiency checkpoint candidate | 0.1.0-beta.37 | pending local commit | 937,925 | 108,515 | JS 1,310,720 / CSS 137,216 | 0 JS / 0 CSS from the recorded beta.36 M41 release candidate | Release-workflow source-cache change only; no desktop UI bundle change. |
