...
| M43 candidate | 0.1.0-beta.38 | pending local commit | pending package build | pending package build | JS 1,310,720 / CSS 137,216; temporary application-shell 327,680 | Candidate production build application shell: 309,489 bytes, 2,289 above the historical 307,200 limit | Explicit transient task-handoff UI. The temporary shell bound remains below the existing total-JS ceiling and requires the planned bundle-reconciliation gate. |
